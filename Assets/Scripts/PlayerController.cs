...
public class PlayerController : MonoBehaviour
{
    ...
    {
        return outfitsOwned[outfitID];
    }

    public void BoughtOutfit(int outfitID)
    {
        outfitsOwned[outfitID] = true;
    }

    public void SoldOutfit(int outfitID)
    {
        outfitsOwned[outfitID] = false;
    }
}
